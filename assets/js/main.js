...
// ABOUT SECTION
gsap.from('.about__title', {opacity: 0, duration: 2, delay: 0.5, y: 25, ease: 'expo.out'});
gsap.from('.about__description', {opacity: 0, duration: 2, delay: 0.7, y: 25, ease: 'expo.out'});
